...
class StartQuizActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set click listener for the Play button to navigate to a different activity (e.g., QuizActivity)
        btnPlay.setOnClickListener {
            val intent = Intent(this, QuizActivity::class.java) // You should have a QuizActivity for the game
